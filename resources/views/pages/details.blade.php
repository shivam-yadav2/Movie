			...
			<div class="row">
						...
						<div class="row">
							...
							<div class="col-12 col-md-7 col-lg-8 col-xl-6 col-xxl-7">
								<div class="item__content">
									<ul class="item__meta">
										<li><span>Director:</span> <a href="{{ asset('actor.html') }}">Vince Gilligan</a></li>
										<li><span>Cast:</span> <a href="{{ asset('actor.html') }}">Brian Cranston</a> <a href="{{ asset('actor.html') }}">Jesse Plemons</a> <a href="{{ asset('actor.html') }}">Matt Jones</a> <a href="{{ asset('actor.html') }}">Jonathan Banks</a> <a href="{{ asset('actor.html') }}">Charles Baker</a> <a href="{{ asset('actor.html') }}">Tess Harper</a></li>
										<li><span>Genre:</span> <a href="{{ asset('catalog.html') }}">Action</a>
										<a href="{{ asset('catalog.html') }}">Triler</a></li>
										<li><span>Premiere::</span> 2019</li>
										<li><span>Running time:</span> 128 min</li>
										<li><span>Country:</span> <a href="{{ asset('catalog.html') }}">USA</a></li>
									</ul>
				...
				<div class="col-12 col-xl-6">
					<video controls crossorigin playsinline poster="../../cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg" id="player">
						<!-- Video files -->
						<source src="{{ asset('https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4') }}" type="video/mp4" size="576">
						<source src="{{ asset('https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4') }}" type="video/mp4" size="720">
						<source src="{{ asset('https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-1080p.mp4') }}" type="video/mp4" size="1080">

						<!-- Caption files -->
						<track kind="captions" label="English" srclang="en" src="{{ asset('https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.en.vtt') }}"
						    default>
						<track kind="captions" label="Français" srclang="fr" src="{{ asset('https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.fr.vtt') }}">

						<!-- Fallback for browsers that don't support the <video> element -->
						<a href="{{ asset('https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4') }}" download>Download</a>
					</video>
				</div>
				<!-- end player -->
			</div>
								...
								<div class="col-12">
									<div class="comments">
										<ul class="comments__list">
											<li class="comments__item">
												<div class="comments__autor">
													<img class="comments__avatar" src="{{ asset('assets/img/user.svg') }}" alt="">
										...
										<ul class="paginator paginator--comments">
											...
											<li class="paginator__item"><a href="{{ asset('#') }}">36</a></li>
										...
										<ul class="reviews__list">
											<li class="reviews__item">
												<div class="reviews__autor">
													<img class="reviews__avatar" src="{{ asset('assets/img/user.svg') }}" alt="">
							...
							<div class="gallery" itemscope>
								<div class="row">
									...
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/img/gallery/project-1.jpg') }}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/img/gallery/project-1.jpg') }}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/img/gallery/project-2.jpg') }}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/img/gallery/project-2.jpg') }}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/img/gallery/project-3.jpg') }}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/img/gallery/project-3.jpg') }}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/img/gallery/project-4.jpg') }}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/img/gallery/project-4.jpg') }}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/img/gallery/project-5.jpg') }}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/img/gallery/project-5.jpg') }}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/img/gallery/project-6.jpg') }}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/img/gallery/project-6.jpg') }}" itemprop="thumbnail" alt="Image description" />
										</a>
